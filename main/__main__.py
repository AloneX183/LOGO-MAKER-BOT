            ...
            return
             ...
             await message.reply_photo(
                 ...
                 reply_markup=InlineKeyboardMarkup( [[
                     ...
                     InlineKeyboardButton(text="Developer", url="t.me/AloneX_Bots")
                     ]]
                     )
                 )
    ...
    if FORCE_SUB:   
        try:             
            ...
            return
             ...
             try:
               text = message.text.replace("logo","").replace("/","").replace("@AloneX_Bots","").strip().upper()
               ...
               if "telegra.ph" not in logo:
                 return await x.edit("`❌ Something Went Wrong...`\n\nReport This Error In @AloneX_BOTS_SUPPORT")
               ...
               await message.reply_photo(logo,caption="**🖼 Logo Generated By @AloneXTG**",reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="Upload As File 📁", callback_data=f"flogo {logo_id}")]]))
               await x.delete()
             except FloodWait:
               pass
    ...
    if FORCE_SUB:   
        try:             
            ...
            return
             ...
             try:
               text = message.text.replace("logosq","").replace("/","").replace("@AloneX_Bots","").strip().upper()
...
async def start_menu(_,query):
  await query.answer()
  await query.message.edit(START,reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="Help", callback_data="help_menu"),InlineKeyboardButton(text="Repo", url="https://github.com/AloneX/LOGO-MAKER-BOT")]]))
...
async def logo_doc(_,query):
  ...
  try:
    ...
    await query.message.reply_document(link,caption="**🖼 Logo Generated By @AloneXTG")
  except FloodWait:
    pass
  except Exception as e:
    try:
